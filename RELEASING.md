...
5. Check `actions/checkout` in `.github/workflows/tests.yml` is still pinned to a SHA, and refresh the pin if it is behind. There is no dependabot on this repo, this line covers its one action.
